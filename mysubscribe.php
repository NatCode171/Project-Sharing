...
<head>
    ...
    <title>Project Sharing - Mes abonnés</title>
...
<body>
    <main>
        ...
        <div class="main">
            ...
            <br>
            <?php
            allusers(true, false); // mysubscribe and subscribe
            if (!empty($myAbonnesIds)) {
                ...
                $placeholders = implode(',', array_fill(0, count($myAbonnesIds), '?'));
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['supr_project'], $_POST['project_id'])) {
                ...
                if ($myStatutInt === $statutAdmin) {
                    ...
                    echo "<div class='alert'><h3>Vous n'Ãªtes pas autorisé Ã  supprimer ce projet.</h3></div>";
                    exit();
                }
            }
            ?>
